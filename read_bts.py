...
# params
from params import *
from utils import record_changes, create_delay_series, create_df, create_gurobi_vars, run_gurobi, create_df2, extract_airline_capacity, color_boxplot
...
while this_date <= end_date:
    ...
    coordinating_airline.append(next_airline)

pd.DataFrame(coordinating_airline).to_csv(save_name+"/coordinating_airline.csv", index=False, header=False)